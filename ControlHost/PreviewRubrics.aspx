<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="PreviewRubrics.aspx.cs" Inherits="Thinkgate.ControlHost.PreviewRubrics" %>
...
<script type="text/javascript">
    ...
    <telerik:RadAjaxPanel ID="updPanel" runat="server" LoadingPanelID="updPanelLoadingPanel"
        ...
        <div runat="server" id="rubricPreviewDiv" clientidmode="Static"></div>
