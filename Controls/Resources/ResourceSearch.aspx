<%@ Page Title="Resource Search" Language="C#" AutoEventWireup="true" CodeBehind="ResourceSearch.aspx.cs" Inherits="Thinkgate.Controls.Resources.ResourceSearch" MasterPageFile="~/Search.Master"%>
...
<asp:Content ID="Content5" ContentPlaceHolderID="LeftColumnContentPlaceHolder" runat="server">
    ...
    <table style="margin-left: auto; margin-right: auto">
        <tr>
            ...
            <td><telerik:RadButton ID="btnClear" runat="server" Text="Clear" ToolTip="Clear report criteria"
    ...
    <e3:Documents ID="ctrlDocuments" CriteriaName="Documents" Text="Documents" runat="server"/>
    <e3:Schools ID="ctrlSchools" CriteriaName="Schools" Text="Schools" runat="server"/>
    <e3:Students ID="ctrlStudents" CriteriaName="Students" Text="Students" runat="server"/>
    <e3:Teachers ID="ctrlTeachers" CriteriaName="Teachers" Text="Teachers" runat="server"/>
    ...
    <asp:Panel runat="server" ID="gridResultsPanel">
        <telerik:RadGrid runat="server" ID="radGridResults" AutoGenerateColumns="False" Width="100%"
            ...
            <ClientSettings EnableRowHoverStyle="true">
                ...
                <Scrolling AllowScroll="True" UseStaticHeaders="True" SaveScrollPosition="True" ScrollHeight="460px">
                </Scrolling>
            </ClientSettings>
            <MasterTableView TableLayout="Auto"  PageSize="100" >
                <Columns>
                    ...
                    <telerik:GridTemplateColumn HeaderText="View" DataField="ViewLink" ItemStyle-Font-Size="Small" HeaderStyle-Width="50" ItemStyle-HorizontalAlign="Center">
                        <ItemTemplate>
                            <a href="<%# ResolveUrl(Eval("ViewLink").ToString()) %>" target="_blank"><asp:Image runat="server" ImageUrl="../Images/ViewPage.png" Width="15" /></a>
                             <a href="<%# ResolveUrl(Eval("ViewLink").ToString()+System.Web.HttpUtility.UrlEncode("&outformat=excel")) %>" target="_blank"><asp:Image ID="ImgExcel" runat="server" imageurl="../../Images/commands/excel_button_edited.png" Width="15"/></a>
