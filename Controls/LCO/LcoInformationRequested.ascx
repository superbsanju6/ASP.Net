<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="LcoInformationRequested.ascx.cs" Inherits="Thinkgate.Controls.LCO.LcoInformationRequested" %>
<telerik:RadAjaxPanel ID="InfoReqAjaxPanel" runat="server" LoadingPanelID="InfoReqLoadingPanel">
	<!-- Filter combo boxes -->
	...
	<!-- Pages -->
		...
		<div class="listView" id="divListView" runat="server">
					<div ID="divListNoResults"  runat="server" Visible="false" style="width: 100%; text-align: center;">No information is requested for selected criteria.</div>
...
<telerik:RadAjaxLoadingPanel ClientIDMode="Static" ID="InfoReqLoadingPanel"
	runat="server" />