<%@ Page Title="Staff Search" Language="C#" MasterPageFile="~/SearchExpanded.Master"
		AutoEventWireup="true" CodeBehind="StaffSearch_Expanded.aspx.cs" Inherits="Thinkgate.Controls.LCO.StaffSearch_Expanded" %>
...
<asp:Content ID="Content5" ContentPlaceHolderID="RightColumnContentPlaceHolder" runat="server">
		...
		<asp:Panel runat="server" ID="gridResultsPanel">
				<telerik:RadGrid runat="server" ID="radGridResults" AutoGenerateColumns="False" Width="100%"
						...
						OnItemDataBound="radGridResults_ItemDataBound" OnSortCommand="OnSortCommand" Height="600px" CssClass="assessmentSearchHeader" Skin="Web20">
						...
						<MasterTableView TableLayout="Auto" Width="800px" PageSize="100" Height="32px">
								<Columns>
