<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="DurationControl.ascx.cs" Inherits="Thinkgate.Controls.E3Criteria.CriteriaControls.DurationControl" %>
<style type="text/css">
...
<div type="CriteriaControl" UIType="<%=UIType %>" key="<%=Key %>">
    ...
    <div id="divToolTipTarget_<%=Key %>" key="<%=Key %>" keyname="<%=Key %>Criteria" style="display: none; padding-left: 5px; padding-top: 5px;" onmouseover="keepDialog();" onmouseout="closeDialog('divToolTipTarget_<%=Key %>');">
        <asp:TextBox runat="server" ID="rtbDuration" MaxLength="3" ToolTip="Enter Time in Days" ClientIDMode="Static" Style="border: solid 1px #6788be; color: #333; font-size: 11.5px; font-family: 'segoe ui', arial, sans-serif; padding-bottom: 3px; padding-top: 2px; padding-left: 5px; padding-right: 5px; " Width="23px" onchange="UpdateDuration(this);" />
			&nbsp;Days&nbsp;<asp:DropDownList ID="DurationHours" runat="server" ToolTip="Enter Time in Hours" ClientIDMode="Static" Style="border: solid 1px #6788be; color: #333; font-size: 11.5px; font-family: 'segoe ui', arial, sans-serif; padding-bottom: 3px; padding-top: 2px; padding-left: 5px; padding-right: 5px; " Width="55px" onchange="UpdateDuration(this);" />
        &nbsp;Hours&nbsp;<asp:DropDownList ID="DurationMinutes" runat="server" ToolTip="Enter Time in Minutes" ClientIDMode="Static" Style="border: solid 1px #6788be; color: #333; font-size: 11.5px; font-family: 'segoe ui', arial, sans-serif; padding-bottom: 3px; padding-top: 2px; padding-left: 5px; padding-right: 5px; " Width="55px" onchange="UpdateDuration(this);" />&nbsp;Minutes						
    </div>
