...
{
    public partial class TextBoxEditRange : Criterion
    {
        #region Page Events
                   ...
                   switch (EditMask)
                    {
                        case Thinkgate.Base.Enums.EditMaskType.DateMask:
                            ...
                            javaScriptBuilder.Append(" $('#" + txt2.ClientID + "').inputmask('dd/mm/yyyy', {placeholder: '_'});");
                            break;
                        case Thinkgate.Base.Enums.EditMaskType.TimeMask:
                            javaScriptBuilder.Append(" $('#" + txt.ClientID + "').inputmask('hh:mm:ss', {placeholder: '_'});");
                            javaScriptBuilder.Append(" $('#" + txt2.ClientID + "').inputmask('hh:mm:ss', {placeholder: '_'});");
                            break;
                        case Thinkgate.Base.Enums.EditMaskType.DateTimeMask:
                            ...
                            javaScriptBuilder.Append(" $('#" + txt2.ClientID + "').inputmask('datetime', {placeholder: '_'});");
                            break;
                        case Thinkgate.Base.Enums.EditMaskType.NumericMask:
                            ...
                            javaScriptBuilder.Append(" $('#" + txt2.ClientID + "').inputmask('integer', {allowMinus: false, allowPlus: false});");
                            break;
