<%@ Control Language="C#" AutoEventWireup="True" CodeBehind="GradeSubjectCourseStandardSetForStandardSearch.ascx.cs" Inherits="Thinkgate.Controls.E3Criteria.GradeSubjectCourseStandardSetForStandardSearch" %>
...
<e3:DropDownList ID="ddlStandardSet" CriteriaName="StandardSet" runat="server" Text="Standard Set" Required="True" EmptyMessage="Select a Standard Set"/>
<e3:CheckBoxList ID="chkGrade" CriteriaName="Grade" runat="server" Text="Grade" Required="True"/>
...
<script type="text/javascript">
    var <%=CriteriaName%>Controller = {
        ...
        PopulateControls: function () {
            ...
            if (typeof <%=ddlStandardSet.CriteriaName%>Controller != 'undefined') {
                var standardSets = CriteriaDataHelpers.GetFieldDistinct(GradeSubjectCourseStandardSetData, _this.StandardSetPos);
                <%=ddlStandardSet.CriteriaName%>Controller.PopulateList(standardSets);
            ...
            if (_this.InitialLoad) {
                ...
                if (typeof <%=ddlStandardSet.CriteriaName%>Controller != 'undefined') <%=ddlStandardSet.CriteriaName%>Controller.CheckDefaultTexts();
