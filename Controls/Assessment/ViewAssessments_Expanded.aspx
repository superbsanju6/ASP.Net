<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ViewAssessments_Expanded.aspx.cs"
    Inherits="Thinkgate.Controls.Assessment.ViewAssessments_Expanded" %>
...
<body>
    ...
    <telerik:RadAjaxPanel ID="updPanel" runat="server" LoadingPanelID="updPanelLoadingPanel"
        Width="100%">
        <asp:Image ID="Image1" runat="server" ImageUrl="~/Images/under-construction-sign.png" />
