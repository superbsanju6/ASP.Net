...
{
    public partial class RenderAssessmentReportCardAsPDF : System.Web.UI.Page
    {
        ...
        private void SetReportConfiguration()
        {
            try
            {
                ...
                var sSRSReportPaths = Thinkgate.Base.Classes.Reports.GetSSRSReportPaths("AssessmentReportCard");
