...
{
    public partial class CredentialTrackingPortalPage : RecordPage
    {
        #region Properties
        ...
        {
            pageTitleLabel.Text = "Credential Tracking Report Portal";
        }
        ...
        private void SetupFolders()
        {
			...
			{
				new Folder("Credential Tracking Report", "~/Images/new/folder_data_analysis.png", LoadCompetencyTrackingReport, "~/ContainerControls/TileReportContainer_1_1.ascx", 1)
			};
