	...
	<tr>
		<td class="reBottomcell">
			<table border="0" cellpadding="0" cellspacing="0" class="reConfirmCancelButtonsTbl">
				<tr>
					<td>
						<button type="button" id="lmInsertButton" class="" style="cursor: pointer">
							<script type="text/javascript">
					...
					<td>
						<button type="button" id="lmCancelButton" style="cursor: pointer">
							<script type="text/javascript">
