<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="True" CodeBehind="BankQuestionPage.aspx.cs" Inherits="Thinkgate.Record.BankQuestionPage" %>
    ...
    <asp:Content ID="Content3" ContentPlaceHolderID="MainContent" runat="server">
        <script type="text/javascript">
            ...
            function ItemPage_openExpandEditRadWindow(sender, args) {
                customDialog({ url: args.command.get_name(), title: "Content Editor - ITEM", maximize: true, maxwidth: 1000, maxheight: 675, autoSize: true, name: 'ContentEditorITEM', onClosed: ItemEditor_OnClientClose, destroyOnClose: true });
            }
            ...
            function copyItem_Confirmed() {
                var ItemPage_hdnEncryptedData = $('#ItemPage_hdnEncryptedData')[0];
                Service2.CopyItemToUserPersonalBank(ItemPage_hdnEncryptedData.value, copyItem_CallBack_Success, copyItem_CallBack_Failure);
            }
