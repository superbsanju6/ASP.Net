...
{
    public partial class SectionChief : RecordPage
    {
        #region Variables
        ...
        {
            get { return EntityTypes.SectionChief + "_"; }
        }
        ...
        private void GetLcoRole()
        {
            ...
            {
                SessionObject.LCOrole = EntityTypes.SectionChief;
        ...
        private void LoadLcoTiles()
        {
            ...
            if (UserHasPermission(Permission.Tile_PendingApproval))
            {
                ...
                pendingApprovalParms.AddParm("lcos", _lcos.Where(lco => ((lco.IsSectionRequested == true) && (lco.IsApproved == false) && (lco.IsInfoRequested != true))).ToList());
