<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" EnableEventValidation="false"
    CodeBehind="District.aspx.cs" Inherits="Thinkgate.Record.District" Async="true" %>
...
<asp:Content ID="Content5" ContentPlaceHolderID="HeaderImageContent" runat="server">
    <asp:Image runat='server' ID="districtImage" ImageUrl="~/Images/new/district_alt.png" Height="50px"   />
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="PageTitleContent" runat="server">
    <asp:Label runat="server" ID="districtName" class="pageTitle" />
</asp:Content>
