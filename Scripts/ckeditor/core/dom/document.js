...
CKEDITOR.tools.extend( CKEDITOR.dom.document.prototype, {
	 ...
	 */
	getActive: function () {
	    //03/18/2014 Charlie Song: added temporarily fix for this. it's a reported bug in ckeditor from vendor website. 
	    //here is link: http://dev.ckeditor.com/ticket/10030. currently status of the bug on the vendor website is a pending status.
	     try {
